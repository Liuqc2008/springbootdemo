...
<head>
 	...
 	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  	...
  	<link href="/web/Script/layui/css/layui.css" rel="stylesheet" type="text/css" />
  
  	<script type="text/javascript" src="/web/Script/jquery-3.3.1.min.js"></script>
  	<script type="text/javascript" src="/web/Script/extend.js"></script>
  	
  	<script type="text/javascript" src="/web/Script/layui/layui.js"></script>
  	<script type="text/javascript" src="/web/Script/Ajax.js"></script>
</head>
<body>
	...
	layui.use(['layer', 'element', 'form', 'table', 'laydate'], function(){
		...
		var table = layui.table,
  		...
  		table.render({
	    	elem: '#test',
	    	url:'/web/Common/GetPageData?reportName=GetAccountList',
	    	cols: [[
